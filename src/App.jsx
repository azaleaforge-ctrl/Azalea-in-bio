      ...
      <ProfileLinksView
        ...
        footer={
          <footer className="reveal mt-10 flex flex-col items-center gap-1.5 text-center">
            ...
            <a href="/" target="_blank" rel="noreferrer" aria-label="Buka Azalea In Bio" className="rounded-lg transition hover:brightness-125 active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-white/60">
